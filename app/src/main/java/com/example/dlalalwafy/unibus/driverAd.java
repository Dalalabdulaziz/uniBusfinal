...
public class driverAd extends AppCompatActivity implements Spinner.OnItemSelectedListener{
    ...
    private void getStudents(JSONArray j){
        ...
        spinner.setAdapter(new ArrayAdapter<String>(driverAd.this, android.R.layout.simple_spinner_dropdown_item, students));
    }
